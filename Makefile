...
#    Updated: 2022/11/23 15:52:19 by abeaudui         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BONUS = ft_lstmap.c ft_lstclear.c ft_lstdelone.c ft_lstnew.c ft_lstadd_front.c ft_lstnew.c ft_lstsize.c ft_lstiter.c
OBJ= $(SRC:.c=.o)
